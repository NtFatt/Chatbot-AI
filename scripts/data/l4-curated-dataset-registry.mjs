...
import * as v4 from './l4-targeted-examples-v4.mjs';
...
export const CURATED_DATASET_DEFINITIONS = {
  ...
  v4: {
    version: 'v4',
    numericVersion: 4,
    name: v4.CURATED_DATASET_NAME,
    description: v4.CURATED_DATASET_DESCRIPTION,
    buildExamples: v4.buildCuratedTrainingExamples,
    getCategoryDistribution: v4.getCategoryDistribution,
  },
};

export const LATEST_STABLE_CURATED_VERSION = 'v4';
